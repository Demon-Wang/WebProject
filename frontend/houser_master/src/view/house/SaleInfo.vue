      ...
      <el-container>
        <el-main >
          ...
          <el-row style="margin-top: 20px;" :gutter="50">
            ...
            <el-col :span="10" >
              <div style ="width:100%;height:400px;">
                <el-row>
                  <el-col>
                    <span style="font-weight: bold;font-size: 30px;color: red">{{Form.price}}万元</span>
                  </el-col>
                </el-row>
                <el-row style="margin-top: 20px">
                  <el-col>
                    <template>
                        <span v-if="Form.property===1">公产</span>
                        <span v-else >私产</span>
                    </template>
                  </el-col>
                </el-row>
          ...
          <el-row>
            ...
            <el-row>
              <el-col :span="8">
                <el-row style="line-height: 30px;">产权：
                    <span style="color:#000000;" v-if="Form.property===1">公产</span>
                    <span style="color:#000000;" v-else >私产</span>
                </el-row>
              ...
              <el-col :span="6">
                <el-row style="line-height: 30px;">朝向：
                  <span style="color:#000000;" v-if="Form.renovation===1">东</span>
                  <span style="color:#000000;" v-else-if="Form.renovation===2">南</span>
                  <span style="color:#000000;" v-else-if="Form.renovation===3">西</span>
                  <span style="color:#000000;" v-else >北</span>
                </el-row>
                ...
                <el-row style="line-height: 30px;">其他说明：{{Form.requirements}}</el-row>
              </el-col>
            </el-row>
          </el-row>
          <el-row>
