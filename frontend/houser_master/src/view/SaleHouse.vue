<template>
  <div>
    ...
    <div style="width: 60%;margin: 0 auto;padding: 20px">
      ...
      <el-row class="crow">
        <label>售价:  </label>
        <el-checkbox label="100万以下" true-label="1" false-label="0"></el-checkbox>
        <el-checkbox label="100万-150万" true-label="1" false-label="0"></el-checkbox>
        <el-checkbox label="150万-200万" true-label="1" false-label="0"></el-checkbox>
        <el-checkbox label="200万以上" true-label="1" false-label="0"></el-checkbox>
      </el-row>
      <el-row class="crow">
        <label>房型:  </label>
    ...
    <div style="width: 60%;margin: 0 auto;padding: 20px">
      ...
      >
        ...
        <el-menu-item index="3">房屋售价</el-menu-item>
        <el-menu-item index="4">房屋面积</el-menu-item>
      </el-menu>
      <el-row>
        <h2>共找到{{total}}套二手房</h2>
      </el-row>
      <el-divider></el-divider>
      <el-row style="width:100%">
        <el-col style="width:85%;float:left">
          ...
          @click.native="info(item.id)">
            ...
            <el-col :span="4" style="height: 100%;">
              <span style="color:red;font-weight: bold;font-size: 28px">{{item.price}}万元</span>
              <br />
            </el-col>
          </el-row>
        </el-col>
