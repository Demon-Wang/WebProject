<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>修改出售信息</el-breadcrumb-item>
    </el-breadcrumb>
        ...
        >
          ...
          <el-tab-pane label="详细信息" name="1">
            <el-form-item label="房屋朝向" prop="towards">
              <el-radio-group v-model="editForm.towards">
          ...
          <el-tab-pane label="出售信息" name="3">
            <el-form-item label="房屋产权" prop="property">
              <el-radio-group v-model="editForm.property">
            ...
            <el-form-item label="其他说明" prop="requirements">
