<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>求租信息列表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <el-row :gutter="20">
        <el-col :span="7">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="addDialogVisible = true">添加求租信息</el-button>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    async getmsgList() {
      const { data:res } = await this.$http.get("demandMsg/getAskBuyMsgs", {
        params:{}
      });
